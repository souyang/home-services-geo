    ...
    <div className="py-16 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div>
            <h2 className="font-poppins font-bold text-3xl text-navy mb-6">Our Story</h2>
          ...
          <div className="bg-light-gray rounded-lg p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="w-8 h-8 bg-sky-blue rounded-full flex items-center justify-center mr-4 flex-shrink-0">
        ...
        {/* Services Overview */}
        <div className="mb-16">
          <h2 className="font-poppins font-bold text-3xl text-navy mb-8 text-center">Our Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white border border-gray-200 rounded-lg p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <Link href="/services/plumbing/" className="text-sky-blue hover:underline text-sm font-medium">
                Learn More →
              </Link>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <Link href="/services/hvac/" className="text-sky-blue hover:underline text-sm font-medium">
                Learn More →
              </Link>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <Link href="/services/electrical/" className="text-sky-blue hover:underline text-sm font-medium">
                Learn More →
              </Link>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <Link href="/services/roofing/" className="text-sky-blue hover:underline text-sm font-medium">
                Learn More →
              </Link>
            </div>
          </div>
        ...
        {/* Values Section */}
        <div className="mb-16">
          <h2 className="font-poppins font-bold text-3xl text-navy mb-8 text-center">Our Values</h2>
        ...
        {/* Service Area */}
        <div className="bg-light-gray rounded-lg p-8 mb-16">
          <h2 className="font-poppins font-bold text-3xl text-navy mb-6 text-center">Service Areas</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <Link href="/service-area/palo-alto/" className="text-sky-blue hover:underline text-sm">
                Learn More →
              </Link>
            </div>
            <div className="text-center">
              ...
              <Link href="/service-area/menlo-park/" className="text-sky-blue hover:underline text-sm">
                Learn More →
              </Link>
            </div>
            <div className="text-center">
              ...
              <Link href="/service-area/mountain-view/" className="text-sky-blue hover:underline text-sm">
                Learn More →
              </Link>
            </div>
          </div>
        ...
        <div className="bg-navy rounded-lg p-8 text-center text-white">
          <h2 className="font-poppins font-bold text-3xl mb-4">Ready to Get Started?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              ...
              className="bg-sky-blue hover:bg-blue-600 text-white font-medium px-8 py-3 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-sky-blue focus:ring-offset-2"
            >
              Call (650) 555-0199
            </a>
            <Link 
              href="/contact/" 
              className="bg-white hover:bg-gray-100 text-navy font-medium px-8 py-3 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2"
            >
              Get Free Estimate
            </Link>
          </div>
